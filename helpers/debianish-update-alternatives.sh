...
sudo update-alternatives \
  --install /usr/bin/llvm-config       llvm-config      /usr/bin/llvm-config-13 200 \
...
sudo update-alternatives \
  --install /usr/bin/clang                    clang                    /usr/bin/clang-13 50 \
  ...
  --slave   /usr/bin/clang-refactor           clang-refactor           /usr/bin/clang-refactor-13 \
